...
# options = dict(starting_balance=2000, initial_profits = 1.012, initial_stop_loss = 0.9, 
...
def Main():
	...
	exchange = Binance()
	#aqui seleciono as moedas que quero filtrar na binance que terminam com BTC, USDT e ETH
	...
	if answer == 'b':
		#para abrir o grafico eh preciso passar o plot como true
		BacktestStrategies(symbols=symbols, interval='30m', plot=True, strategy_evaluators=strategy_evaluators)
	if answer == 'q':
		print("\nBYE!\n")
